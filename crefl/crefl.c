...
/**************************************************************************//**
 function to get the elev of a point from the dem subdataset

 @param lat     latitude of point
 @param lon     longitude of point
 @param dem     dem subdataset

 @returns elevation of the point at lat,lon
...
/**************************************************************************//**
 ...
 @param verbose  non zero to prinx extra info
...
/**************************************************************************//**
 ...
 @param sd_id
 @param MOD021KMfile name of 1km input file
 @param MOD02HKMfile name of 500m input file
 @param MOD02QKMfile name of 250m inpyut file
 @param maxsolz
 @param sealevel
 @param TOA
 @param nearest
...
/**************************************************************************//**
 ...
 @param xmin    min value in range
 @param xmax    max value in range

 @return 0 if xmin <= x <= xmax, non-zero otherwise.
